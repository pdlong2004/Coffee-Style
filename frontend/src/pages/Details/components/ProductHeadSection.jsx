  ...
  return (
    <div className="flex flex-col lg:grid grid-cols-2 gap-10 my-25">
      ...
      <div className="flex flex-col justify-center items-center lg:items-start">
        <div className="text-4xl mt-2.5 mb-3.75 text-center lg:text-left">
          {product.name}
        </div>
        <p className="text-lg/[30px] text-[#1d1f2eb3] text-center lg:text-left ">
          {product.description}
        </p>
        <div className="my-7.5">
          ...
          >
            <span
              className={`${
                product.oldPrice
                  ? "text-3xl text-coffee"
                  : "text-3xl text-black font-medium"
              }`}
            >
